...
const introduce: IIntroduce.Payload = {
  ...
  contents: [
    ...
    'Agentic AI의 결과물은 모델의 성능보다 프로젝트에 필요한 하네스가 좌우한다고 생각합니다. 문서와 규칙을 정리하고, 반복해서 놓치는 실수는 Skill과 Hook으로 검증합니다. 구현은 맡기더라도, 무엇을 왜 만들지 정하고 결과가 맞는지 판단하는 일은 제 몫으로 남겨둡니다. 그 판단의 기준을 잃지 않으며, 제가 만든 소프트웨어에 대해 제 생각을 자신 있게 말할 수 있는 엔지니어가 되고자 합니다.',
