...
const introduce: IIntroduce.Payload = {
  ...
  contents: [
    'I enjoy defining problems myself and solving them. I have owned services end to end, from planning through development and operation. When a problem would not yield, I looked one layer down — and the answer could always be found in the fundamentals of computer science. That is why, as much as I work with new technologies, I invest time in solidifying the principles beneath them.',
