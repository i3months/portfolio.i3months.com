...
const introduce: IIntroduce.Payload = {
  ...
  contents: [
    'I enjoy defining problems myself and solving them. I have owned services end to end, from planning through development and operation, and once I take on a problem, I dig all the way in. When I get stuck, I look one layer down — and problems followed that deep always found their answers in fundamentals like networks, databases, and operating systems. That is why I invest in fundamentals as much as in new tools.',
