...
const introduce: IIntroduce.Payload = {
  ...
  contents: [
    'I enjoy defining problems myself and solving them. I have started services from inconveniences I experienced firsthand and carried them from planning through development and operation, and once I take on a problem, I dig all the way down. When the answer is not in the code, I go one layer deeper — and problems followed that deep always came down to fundamentals like networks, databases, and operating systems. That is why I invest in fundamentals as much as in new tools.',
